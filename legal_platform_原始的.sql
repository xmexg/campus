...
INSERT INTO `edu_content` VALUES (3, 'VIDEO', '民法典与生活', '视频普法：合同与侵权责任', NULL, 'https://www.w3schools.com/html/mov_bbb.mp4', NULL, '视频课程', 0, 1, 'PUBLISHED', NULL, 1, '2026-03-20 15:47:13', '2026-03-20 15:47:13');
INSERT INTO `edu_content` VALUES (4, 'NEWS', '「法治进校园」主题讲座本周三举行', '欢迎师生报名参加，现场可领取学习资料。', '学生处与法学院联合举办「法治进校园」专题讲座，邀请执业律师讲解校园贷、网络诈骗防范与维权途径。地点：学术报告厅；时间：周三 14:00-16:00。', NULL, NULL, '校园动态', 156, 1, 'PUBLISHED', NULL, 1, '2026-03-20 16:57:47', '2026-03-20 16:57:47');
INSERT INTO `edu_content` VALUES (5, 'ARTICLE', '劳动合同试用期，这些坑不要踩', '试用期内工资、解除与社保，一文说清。', '试用期最长不得超过法定期限；同一用人单位与同一劳动者只能约定一次试用期；试用期工资不得低于合同约定工资的 80% 且不得低于当地最低工资标准……（以下为示例正文，可替换为真实普法稿。）', NULL, NULL, '劳动权益', 89, 1, 'PUBLISHED', NULL, 1, '2026-03-20 16:57:47', '2026-03-20 16:57:47');
...
INSERT INTO `edu_content` VALUES (8, 'VIDEO', '防电信诈骗：常见话术识别', '短视频示例，配合案例讲解。', NULL, 'https://www.w3schools.com/html/mov_bbb.mp4', NULL, '安全防范', 45, 1, 'PUBLISHED', NULL, 1, '2026-03-20 16:57:47', '2026-03-20 16:57:47');
...
-- ----------------------------
INSERT INTO `forum_post` VALUES (1, 3, '求助：实习协议里竞业条款有效吗？', '下周要签三方和实习协议，里面有一段竞业限制，想请教老师和同学这种对在校生是否常见？', 'APPROVED', NULL, 88, '2026-03-20 16:57:47', '2026-03-20 16:57:47');
...
INSERT INTO `sys_user` VALUES (4, '111111', '$2a$10$5Hgjg6AIiaiRdyIVqywti.6c52YQ2Df6SwbK8Pqjvgzp/tbMMM7XS', '小张', '', 'STUDENT', 1, 'PENDING', NULL, NULL, 'NONE', NULL, NULL, NULL, '/api/uploads/files/03724bd1e1474c28aad57082a7729dfc.jpg', '2026-03-20 16:38:30', '2026-03-20 17:08:18');
INSERT INTO `sys_user` VALUES (5, 'xiaozhang', '$2a$10$enxeGC/KYXOsLl0dO7SXU.zYpWj5gJY7YcAYGMYLs.RugUhcXEHPS', '小张', '13900001001', 'STUDENT', 1, 'PENDING', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, '2026-03-20 16:57:47', '2026-03-20 16:57:47');
