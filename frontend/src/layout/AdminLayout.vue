...
import { Back, DataAnalysis, Document, Expand, Fold, Notebook, Setting, UserFilled } from '@element-plus/icons-vue'
...
const pageTitle = computed(() => route.meta.title || '数据统计')
    ...
    <el-aside :width="asideWidth + 'px'" class="ruoyi-aside">
      ...
      <el-scrollbar class="menu-scroll">
        ...
        >
          ...
          <el-menu-item index="/admin/forum-audit">
            <el-icon><Document /></el-icon>
            <template #title>发帖审核</template>
          </el-menu-item>
          ...
          <template v-if="showAdminOnlyMenu">
            <el-sub-menu index="sys">
              ...
              <el-menu-item index="/admin/system">用户与备份</el-menu-item>
